...
- **Thread architecture:** [Threads & Persistence Architecture](/mastra/premium/threads-explained) — event replay model and WebSocket sync
- **Production self-hosting:** [Self-host CopilotKit Intelligence](/mastra/premium/self-hosting) — run the Threads platform inside your infrastructure with CopilotKit Engineering
