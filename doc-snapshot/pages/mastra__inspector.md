...
[Rich Thread](/mastra/threads) and choose **Try from here**. Inspector copies its
...
choose **Copy setup prompt**. See [Learning](/mastra/learning) for the complete workflow.
