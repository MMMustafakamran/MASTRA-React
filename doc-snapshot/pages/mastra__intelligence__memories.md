...
conversation, read [Threads & Persistence Architecture](/mastra/intelligence/threads-explained)
instead.
...
- **Threads:** [Threads & Persistence Architecture](/mastra/intelligence/threads-explained), the
  persistence model for a single conversation
- **Platform:** [CopilotKit Intelligence](/mastra/intelligence/overview), where
  memory sits among the other pillars
- **Self-hosting:** [Self-hosting Intelligence](/mastra/intelligence/self-hosting),
