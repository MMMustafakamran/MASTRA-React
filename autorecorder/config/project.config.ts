...
export const PROJECT: ProjectConfig = {
  framework: "mastra",
  frameworkLabel: "Mastra (TypeScript)",
  videoPrefix: "MASTRA-react",

  docBaseUrl: "https://docs.copilotkit.ai/mastra",
  ...
  backendStartCmd: "(no separate agent server — getLocalAgents runs Mastra inside Next)",
